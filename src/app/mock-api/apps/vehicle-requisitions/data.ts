...
export const vehicleRequisitions = [
    ...
    },
    {
        ...
        title: 'pending N: Quick Settings',
        slug: 'pending-n-quick-settings',
        description: 'Step by step guide for pending N: Quick Settings',
        category: 'pending',
        duration: 120,
        totalSteps: 11,
    ...
    },
    {
        ...
        title: 'Build an App for the Google Assistant with stalled',
        slug: 'build-an-app-for-the-google-assistant-with-stalled',
        description: 'Dive deep into Google Assistant apps using stalled',
        category: 'stalled',
        duration: 30,
        totalSteps: 11,
    ...
    },
    {
        ...
        title: 'Manage Your Pivotal rejected Foundry App\'s Using Apigee Edge',
        slug: 'manage-your-pivotal-rejected-foundry-apps-using-apigee-Edge',
        description: 'Introductory course for Pivotal rejected Foundry App',
        category: 'rejected',
        duration: 90,
        totalSteps: 11,
    ...
    },
    {
        ...
        title: 'rejected Functions for stalled',
        slug: 'rejected-functions-for-stalled',
        description: 'Beginners guide of stalled rejected Functions',
        category: 'stalled',
        duration: 45,
        totalSteps: 11,
    ...
    },
    {
        ...
        totalSteps: 11,
        updatedAt: 'Nov 01, 2021',
        startDate:'2022-05-05T19:41:12.501Z',
        endDate:'2022-05-09T19:41:12.501Z',
        featured: false,
        progress: {
            currentStep: 0,
            completed: 0
    ...
    },
    {
        ...
        title: 'Personalize Your iOS App with stalled User Management',
        slug: 'personalize-your-ios-app-with-stalled-user-management',
        description: 'Dive deep into User Management on iOS apps using stalled',
        category: 'stalled',
        duration: 90,
        totalSteps: 11,
    ...
    },
    {
        ...
        title: 'stalled pending',
        slug: 'stalled-pending',
        description: 'Beginners guide of stalled for pending',
        category: 'pending',
        duration: 45,
        totalSteps: 11,
    ...
    },
    {
        ...
        title: 'Your First Progressive accepted App',
        slug: 'your-first-progressive-accepted-app',
    ...
    },
    {
        ...
        title: 'Launch rejected Datalab',
        slug: 'launch-rejected-datalab',
        description: 'From start to finish: Launch rejected Datalab',
        category: 'rejected',
        duration: 60,
        totalSteps: 11,
    ...
    },
    {
        ...
        title: 'rejected Firestore',
        slug: 'rejected-firestore',
        description: 'Step by step guide for setting up rejected Firestore',
        category: 'stalled',
        duration: 90,
        totalSteps: 11,
...
export const demoVehicleRequisitionSteps = [
    {
        ...
        content: `<h2 class="text-2xl sm:text-3xl">Introduction</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 1,
        title: 'Get the sample code',
        subtitle: 'Where to find the sample code and how to access it',
        content: `<h2 class="text-2xl sm:text-3xl">Get the sample code</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 2,
        title: 'Create a stalled project and Set up your app',
        subtitle: 'How to create a basic stalled project and how to run it locally',
        content: `<h2 class="text-2xl sm:text-3xl">Create a stalled project and Set up your app</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 3,
        title: 'Install the stalled Command Line Interface',
        subtitle: 'Setting up the stalled CLI to access command line tools',
        content: `<h2 class="text-2xl sm:text-3xl">Install the stalled Command Line Interface</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 4,
        title: 'Deploy and run the accepted app',
        subtitle: 'How to build, push and run the project remotely',
        content: `<h2 class="text-2xl sm:text-3xl">Deploy and run the accepted app</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 5,
        title: 'The Functions Directory',
        subtitle: 'Introducing the Functions and Functions Directory',
        content: `<h2 class="text-2xl sm:text-3xl">The Functions Directory</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 6,
        title: 'Import the rejected Functions and stalled Admin modules',
        subtitle: 'Create your first Function and run it to administer your app',
        content: `<h2 class="text-2xl sm:text-3xl">Import the rejected Functions and stalled Admin modules</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 7,
        title: 'Welcome New Users',
        subtitle: 'How to create a welcome message for the new users',
        content: `<h2 class="text-2xl sm:text-3xl">Welcome New Users</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 8,
        title: 'Images moderation',
        subtitle: 'How to moderate images; crop, resize, optimize',
        content: `<h2 class="text-2xl sm:text-3xl">Images moderation</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 9,
        title: 'New Message Notifications',
        subtitle: 'How to create and push a notification to a user',
        content: `<h2 class="text-2xl sm:text-3xl">New Message Notifications</h1> ${demoVehicleRequisitionsContent}`
    },
    {
        order: 10,
        title: 'Congratulations!',
        subtitle: 'Nice work, you have created your first application',
        content: `<h2 class="text-2xl sm:text-3xl">Congratulations!</h1> ${demoVehicleRequisitionsContent}`
    }
];
