...
export const cashRequisitions = [
    {
        ...
        description: 'I want  a vehcle tommorow , I have a customer visit at Shasha',
        category: 'pending',
        startDate: "19/05/222",
        endDate: "21/05/2022",
        duration: 2,
    ...
    },
    {
        ...
        title: 'Requesting vehicle',
        slug: 'basics-of-typeScript',
        description: 'Requesting the corolla 2012 to go for service today at 4pm',
        category: 'accepted',
        duration: 1,
        totalSteps: 4,
        startDate: "19/05/222",
...
export const demoCashRequisitionSteps = [
    {
        order: 0,
        title: 'Pending',
        subtitle: 'Vehicle requsition pending approval',
        content: `<h2 class="text-2xl sm:text-3xl">Pending</h1> <p class="lead">
        Vehicle requisition send to line manager for approval please wait while they review it. Sure the will get back to you.
    </p>`
    },
    {
        order: 1,
        title: 'Accpeted',
        subtitle: 'Vehicle requsition accepted',
        content: `<h2 class="text-2xl sm:text-3xl">Accepted</h1> <p class="lead">
        Vehicle requisition has been accepted by the line manager it has been send to the finace department wait for Finance approval then you are good to go.
    </p>`
    },
    {
        order: 2,
        title: 'Finance Approval',
        subtitle: 'Finance department has approved your requisition',
        content: `<h2 class="text-2xl sm:text-3xl">Finance Approval</h1> <p class="lead">
        Finance department has approved your vehicle requisition they have assigned you the Silver Corolla 2012
    </p>`
    },
    {
        order: 3,
        title: 'Vehcile Collection',
        subtitle: 'Corolla 2012 ready For collection',
        content: `<h2 class="text-2xl sm:text-3xl">Vehicle Collection</h1> <p class="lead">
        Vehicle is ready to be collected and your slot starts tommorow 08:30am please be on time.
    </p>`
    },
