...
export class CashRequisitionDetailsComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        // Get the course
        this._cashRequisitionService.CashRequisition$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((cashRequisition:CashRequisition) => {

                // Get the course
                this.cashRequisition = cashRequisition;

                // Go to step
                this.goToStep(cashRequisition.progress.currentStep);
