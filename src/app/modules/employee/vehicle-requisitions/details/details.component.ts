...
export class VehicleRequisitionDetailsComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        // Get the course
        this._vehicleRequisitionService.vehicleRequisition$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((vehicleRequisition:VehicleRequisition) => {

                // Get the course
                this.vehicleRequisition = vehicleRequisition;

                // Go to step
                this.goToStep(vehicleRequisition.progress.currentStep);
